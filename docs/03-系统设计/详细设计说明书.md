...
| 对象 | 说明 | 关键字段 |
| --- | --- | --- |
| `KnowledgeBase` | 知识库工作空间 | kbId、name、description、ownerId、defaultSecurityLevel、sparseIndexEnabled、graphIndexEnabled、status |
...
- 目标版本的解析状态必须为成功，并且知识库索引能力要求的 Dense / Sparse / Graph 副本必须已完成或标记为 `not_required`。
