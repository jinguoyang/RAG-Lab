...
| --- | --- | --- | --- | --- | --- | --- |
| S12-001 | B-053 | 建立 V1.0 端到端验收脚本 | P0 | 1d | Codex | Done |
| S12-002 | B-054 | 补齐权限与跨 KB 回归用例 | P0 | 1d | Codex | Done |
| S12-003 | B-055 | 将验收清单 A-001~A-005 半自动回填为可复核结果 | P0 | 0.5d | Codex | Done |
| S12-004 | B-059 | 让 P08 保存的核心参数参与 QA 执行 | P0 | 1d | Codex | Done |
