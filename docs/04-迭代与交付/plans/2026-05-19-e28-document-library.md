...
| Sprint 37 | TXT/DOCX 预览、绑定/解绑 API、P06 从文档库添加、绑定后切块向量化、文档使用情况 | 文档可绑定多个知识库；绑定后生成知识库级 Chunk 和检索副本 |
| Sprint 38 | 权限码收口、批量操作、P02 统计卡片、大文件体验、失败重试、测试覆盖 | 批量与异常路径可验证；端到端测试覆盖上传、预览、绑定和使用情况 |
