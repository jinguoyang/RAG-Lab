...
| --- | --- | --- | --- | --- | --- | --- |
| S24-001 | B-105 | 完善真实文档 QA 的历史回放、复跑和差异对比 | P0 | 1.5d | Codex | Done |
| S24-002 | B-106 | P06/P07/P09/P10 展示真实链路状态和失败原因 | P1 | 1.5d | Codex | Done |
| S24-003 | B-107 | 建立 V1.6 真实文档 RAG 端到端验收脚本 | P0 | 1.5d | Codex | Done |
| S24-004 | B-108 | 补齐真实依赖复测记录和环境限制说明 | P1 | 1d | Codex | Done |
