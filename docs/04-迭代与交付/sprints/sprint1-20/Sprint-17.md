...
| --- | --- | --- | --- | --- | --- | --- |
| S17-001 | B-073 | 采集 QARun、IngestJob 和 Provider 调用关键运行指标 | P1 | 1d | Codex | Done |
| S17-002 | B-074 | 增加慢链路诊断、错误摘要和健康面板接口 | P1 | 1d | Codex | Done |
| S17-003 | B-075 | 补齐任务幂等、补偿和重复执行回归用例 | P1 | 1.5d | Codex | Done |
| S17-004 | B-076 | 建立备份恢复演练脚本和恢复结果回填文档 | P2 | 1d | Codex | Done |
