...
| --- | --- | --- | --- | --- |
| B-293 | 外部培训应用题库审核页面 | P0 | 2d | Done |
| B-294 | 外部培训应用课堂页面 | P0 | 2d | Done |
| B-295 | 外部培训应用结构化答题组件 | P0 | 2d | Done |
...
- B-293: 外部培训应用题库审核页面 — Done（集成在 ReviewPage 中）
- B-294: 外部培训应用课堂页面 — Done（ClassroomPage，支持状态流转和多轮对话）
- B-295: 外部培训应用结构化答题组件 — Done（ChoiceQuestion A/B/C/D 组件）
