...
- Sprint 66 开发中，主题为 E34 多查询融合与大小 Chunk 上下文：B-322 保留 In Progress，B-323 已补入 QA Run chunkWindow 上下文扩展并进入 In Review。
...
| Sprint 66 | 高质量 RAG 核心优化 | 多查询融合与大小 Chunk 上下文 | In Progress | `sprint61-80/Sprint-66.md` |
