...
| --- | --- | --- | --- | --- | --- | --- |
| S22-001 | B-097 | 完善 QARun 回放上下文快照 | P0 | 1.5d | Codex | Done |
| S22-002 | B-098 | 支持回放复跑、结果对比和配置差异对比 | P0 | 2d | Codex | Done |
| S22-003 | B-099 | 补齐真实检索链路下的权限裁剪回归 | P0 | 1.5d | Codex | Done |
| S22-004 | B-100 | 建立 V1.5 真实 QA 与回放验收脚本 | P0 | 1d | Codex | Done |
