...
| E5 | 真实 Provider 接入 | V1.0 | Done | Sprint 06、Sprint 13 | Provider 抽象、配置摘要和连通性诊断入口已完成；真实环境网络级复测按发布运维记录执行 |
...
| E14 | Provider 生产化接入 | V1.2 | Done | Sprint 15 | 补齐真实 Provider 凭据、诊断、限流和发布环境复测 |
...
| E20 | 真实 RAG 有效闭环 | V1.6 | Done | Sprint 23、Sprint 24 | 基于真实文档完成解析、索引、检索、生成、监控和回放的端到端验收闭环 |
| E21 | RAG 模块化调优 | V1.7 | Done | Sprint 25、Sprint 26 | 丰富可配置检索节点、节点参数、Pipeline 快照和评估对比能力 |
