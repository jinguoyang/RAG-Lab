...
| E11 | 验收硬化 | V1.0 | Partial | Sprint 12、Sprint 13 | 端到端验收脚本和权限回归已完成；验收报告与遗留风险清单待完成 |
| E12 | RAG 质量闭环 | V1.0/V1.1 | Partial | Sprint 12、Sprint 13 | P08 参数生效已完成；EvaluationRun/Result 和 P10 结果视图待完成 |
| E13 | 配置优化闭环 | V1.1 | Todo | Sprint 14 | 从评估结果出发，完成配置差异对比和优化草稿闭环 |
