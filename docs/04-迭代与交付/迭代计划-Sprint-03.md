...
| --- | --- | --- | --- | --- | --- | --- |
| S3-001 | B-010 | 实现文档、文档版本、IngestJob 基础表与迁移 | P0 | 1.5d |  | Todo |
| S3-002 | B-011 | 实现文档上传元数据接口，生成 Document、Version、IngestJob | P0 | 2d |  | Todo |
| S3-003 | B-012 | 实现文档列表、详情、版本列表和作业状态接口 | P0 | 2d |  | Todo |
