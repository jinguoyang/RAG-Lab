...
system_dict_types = sa.Table(
    "system_dict_types",
    metadata,
    sa.Column("dict_type_id", sa.String(36), primary_key=True),
...
system_dict_items = sa.Table(
    "system_dict_items",
    metadata,
    sa.Column("dict_item_id", sa.String(36), primary_key=True),
    sa.Column("dict_type_id", sa.String(36), nullable=False),
    sa.Column("code", sa.String(length=64), nullable=False),
    sa.Column("name", sa.String(length=128), nullable=False),
    sa.Column("description", sa.Text(), nullable=True),
...
user_group_members = sa.Table(
    "user_group_members",
    metadata,
    sa.Column("group_member_id", sa.String(36), primary_key=True),
...
knowledge_bases = sa.Table(
    ...
    sa.Column("status", sa.String(length=16), nullable=False),
    sa.Column("active_config_revision_id", sa.String(36), nullable=True),
...
role_permission_bindings = sa.Table(
    ...
    metadata,
    sa.Column("role_permission_id", sa.String(36), primary_key=True),
...
acl_rules = sa.Table(
    "acl_rules",
    metadata,
    sa.Column("acl_rule_id", sa.String(36), primary_key=True),
...
document_libraries = sa.Table(
    "document_libraries",
    metadata,
    sa.Column("library_id", sa.String(36), primary_key=True),
    sa.Column("owner_id", sa.String(36), nullable=False),
    sa.Column("name", sa.String(length=128), nullable=False),
    sa.Column("description", sa.Text(), nullable=True),
    sa.Column("status", sa.String(length=16), nullable=False),
...
chunk_access_filters = sa.Table(
    ...
    metadata,
    sa.Column("access_filter_id", sa.String(36), primary_key=True),
...
audit_logs = sa.Table(
    "audit_logs",
    metadata,
    sa.Column("audit_log_id", sa.String(36), primary_key=True),
...
documents = sa.Table(
    ...
    sa.Column("library_id", sa.String(36), nullable=True),
...
document_kb_bindings = sa.Table(
    ...
    sa.Column("updated_by", sa.String(36), nullable=True),
    # 新增字段
    sa.Column("active_chunk_revision_id", sa.String(36), nullable=True),
)
...
parse_revisions = sa.Table(
    "parse_revisions",
    metadata,
    sa.Column("parse_revision_id", sa.String(36), primary_key=True),
...
chunk_revisions = sa.Table(
    "chunk_revisions",
    metadata,
    sa.Column("chunk_revision_id", sa.String(36), primary_key=True),
    sa.Column("binding_id", sa.String(36), nullable=False),
    sa.Column("knowledge_base_id", sa.String(36), nullable=False),
    sa.Column("document_id", sa.String(36), nullable=False),
    sa.Column("document_version_id", sa.String(36), nullable=False),
    sa.Column("parse_revision_id", sa.String(36), nullable=False),
    sa.Column("status", sa.String(length=16), nullable=False),
...
chunks = sa.Table(
    ...
    sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
    # 新增字段
    sa.Column("chunk_revision_id", sa.String(36), nullable=True),
    sa.Column("parse_revision_id", sa.String(36), nullable=True),
...
index_sync_jobs = sa.Table(
    "index_sync_jobs",
    metadata,
    sa.Column("sync_job_id", sa.String(36), primary_key=True),
    sa.Column("kb_id", sa.String(36), nullable=False),
...
index_sync_records = sa.Table(
    "index_sync_records",
    metadata,
    sa.Column("sync_record_id", sa.String(36), primary_key=True),
...
config_revisions = sa.Table(
    "config_revisions",
    metadata,
    sa.Column("config_revision_id", sa.String(36), primary_key=True),
    sa.Column("kb_id", sa.String(36), nullable=False),
...
qa_runs = sa.Table(
    ...
    sa.Column("kb_id", sa.String(36), nullable=False),
    sa.Column("config_revision_id", sa.String(36), nullable=False),
...
qa_run_trace_steps = sa.Table(
    "qa_run_trace_steps",
    metadata,
    sa.Column("trace_step_id", sa.String(36), primary_key=True),
...
rag_apps = sa.Table(
    ...
    sa.Column("kb_id", sa.String(36), nullable=False),
    sa.Column("default_config_revision_id", sa.String(36), nullable=True),
    sa.Column("name", sa.String(length=128), nullable=False),
    sa.Column("description", sa.Text(), nullable=True),
    sa.Column("status", sa.String(length=16), nullable=False),
...
rag_app_api_keys = sa.Table(
    "rag_app_api_keys",
    metadata,
    sa.Column("api_key_id", sa.String(36), primary_key=True),
...
app_messages = sa.Table(
    ...
    sa.Column("content", sa.Text(), nullable=False),
    sa.Column("qa_run_id", sa.String(36), nullable=True),
    sa.Column("status", sa.String(length=16), nullable=False),
    sa.Column("metadata", sa.JSON(), nullable=False),
    sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
)
...
evaluation_results = sa.Table(
    ...
    sa.Column("source_run_id", sa.String(36), nullable=True),
    sa.Column("actual_run_id", sa.String(36), nullable=True),
    sa.Column("status", sa.String(length=16), nullable=False),
    sa.Column("query", sa.Text(), nullable=False),
    sa.Column("expected_answer", sa.Text(), nullable=True),
...
graph_snapshots = sa.Table(
    "graph_snapshots",
    metadata,
    sa.Column("graph_snapshot_id", sa.String(36), primary_key=True),
    sa.Column("kb_id", sa.String(36), nullable=False),
...
graph_chunk_refs = sa.Table(
    "graph_chunk_refs",
    metadata,
    sa.Column("graph_chunk_ref_id", sa.String(36), primary_key=True),
    sa.Column("graph_snapshot_id", sa.String(36), nullable=False),
    sa.Column("chunk_id", sa.String(36), nullable=False),
