...
from app.core.db_types import UUIDString
...
system_dict_types = sa.Table(
    "system_dict_types",
    metadata,
    sa.Column("dict_type_id", UUIDString(), primary_key=True),
...
system_dict_items = sa.Table(
    "system_dict_items",
    metadata,
    sa.Column("dict_item_id", UUIDString(), primary_key=True),
    sa.Column("dict_type_id", UUIDString(), nullable=False),
    sa.Column("code", sa.String(length=64), nullable=False),
    sa.Column("name", sa.String(length=128), nullable=False),
    sa.Column("description", sa.Text(), nullable=True),
...
user_groups = sa.Table(
    "user_groups",
    metadata,
    sa.Column("group_id", UUIDString(), primary_key=True),
    sa.Column("name", sa.String(length=128), nullable=False),
    sa.Column("description", sa.Text(), nullable=True),
    sa.Column("status", sa.String(length=16), nullable=False),
    sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
...
user_group_members = sa.Table(
    "user_group_members",
    metadata,
    sa.Column("group_member_id", UUIDString(), primary_key=True),
    sa.Column("group_id", UUIDString(), nullable=False),
    sa.Column("user_id", UUIDString(), nullable=False),
    sa.Column("status", sa.String(length=16), nullable=False),
...
knowledge_bases = sa.Table(
    "knowledge_bases",
    metadata,
    sa.Column("kb_id", UUIDString(), primary_key=True),
    sa.Column("name", sa.String(length=128), nullable=False),
    sa.Column("description", sa.Text(), nullable=True),
    sa.Column("owner_id", UUIDString(), nullable=False),
    ...
    sa.Column("status", sa.String(length=16), nullable=False),
    sa.Column("active_config_revision_id", UUIDString(), nullable=True),
...
kb_member_bindings = sa.Table(
    "kb_member_bindings",
    metadata,
    sa.Column("binding_id", UUIDString(), primary_key=True),
    sa.Column("kb_id", UUIDString(), nullable=False),
    sa.Column("subject_type", sa.String(length=16), nullable=False),
    sa.Column("subject_id", UUIDString(), nullable=False),
...
permissions = sa.Table(
    "permissions",
    metadata,
    sa.Column("permission_id", UUIDString(), primary_key=True),
...
role_permission_bindings = sa.Table(
    ...
    metadata,
    sa.Column("role_permission_id", UUIDString(), primary_key=True),
...
acl_rules = sa.Table(
    "acl_rules",
    metadata,
    sa.Column("acl_rule_id", UUIDString(), primary_key=True),
    sa.Column("resource_type", sa.String(length=32), nullable=False),
    sa.Column("resource_id", UUIDString(), nullable=False),
    sa.Column("subject_type", sa.String(length=16), nullable=False),
    sa.Column("subject_id", UUIDString(), nullable=False),
    sa.Column("effect", sa.String(length=16), nullable=False),
    sa.Column("permission_code", sa.String(length=64), nullable=False),
...
document_libraries = sa.Table(
    "document_libraries",
    metadata,
    sa.Column("library_id", UUIDString(), primary_key=True),
    sa.Column("owner_id", UUIDString(), nullable=False),
    sa.Column("name", sa.String(length=128), nullable=False),
    sa.Column("description", sa.Text(), nullable=True),
    sa.Column("status", sa.String(length=16), nullable=False),
...
library_member_bindings = sa.Table(
    ...
    metadata,
    sa.Column("binding_id", UUIDString(), primary_key=True),
    sa.Column("library_id", UUIDString(), nullable=False),
    sa.Column("subject_type", sa.String(length=16), nullable=False),
    sa.Column("subject_id", UUIDString(), nullable=False),
...
chunk_access_filters = sa.Table(
    ...
    metadata,
    sa.Column("access_filter_id", UUIDString(), primary_key=True),
    sa.Column("chunk_id", UUIDString(), nullable=False),
    sa.Column("kb_id", UUIDString(), nullable=False),
    sa.Column("permission_code", sa.String(length=64), nullable=False),
    sa.Column("allow_subject_keys", sa.JSON(), nullable=False),
    sa.Column("deny_subject_keys", sa.JSON(), nullable=False),
...
audit_logs = sa.Table(
    "audit_logs",
    metadata,
    sa.Column("audit_log_id", UUIDString(), primary_key=True),
    sa.Column("actor_id", UUIDString(), nullable=True),
    sa.Column("action", sa.String(length=64), nullable=False),
    sa.Column("resource_type", sa.String(length=32), nullable=False),
    sa.Column("resource_id", UUIDString(), nullable=False),
    sa.Column("kb_id", UUIDString(), nullable=True),
    sa.Column("document_id", UUIDString(), nullable=True),
...
stored_files = sa.Table(
    "stored_files",
    metadata,
    sa.Column("file_id", UUIDString(), primary_key=True),
...
documents = sa.Table(
    "documents",
    metadata,
    sa.Column("document_id", UUIDString(), primary_key=True),
    sa.Column("kb_id", UUIDString(), nullable=True),
    sa.Column("owner_id", UUIDString(), nullable=True),
    sa.Column("library_id", UUIDString(), nullable=True),
    sa.Column("name", sa.String(length=255), nullable=False),
    sa.Column("source_type", sa.String(length=32), nullable=False),
    sa.Column("status", sa.String(length=16), nullable=False),
    sa.Column("active_version_id", UUIDString(), nullable=True),
    sa.Column("metadata", sa.JSON(), nullable=False),
    sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
    sa.Column("created_by", UUIDString(), nullable=True),
    sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
...
document_kb_bindings = sa.Table(
    ...
    sa.Column("updated_by", UUIDString(), nullable=True),
    # 新增字段
    sa.Column("active_chunk_revision_id", UUIDString(), nullable=True),
)

library_parse_jobs = sa.Table(
    "library_parse_jobs",
    metadata,
    sa.Column("job_id", UUIDString(), primary_key=True),
    sa.Column("document_id", UUIDString(), nullable=False),
    sa.Column("version_id", UUIDString(), nullable=False),
...
document_versions = sa.Table(
    "document_versions",
    metadata,
    sa.Column("version_id", UUIDString(), primary_key=True),
    sa.Column("document_id", UUIDString(), nullable=False),
    sa.Column("version_no", sa.Integer(), nullable=False),
    sa.Column("source_file_id", UUIDString(), nullable=False),
    sa.Column("status", sa.String(length=16), nullable=False),
    ...
    sa.Column("error_message", sa.Text(), nullable=True),
    sa.Column("metadata", sa.JSON(), nullable=False),
    sa.Column("active_parse_revision_id", UUIDString(), nullable=True),
    sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
    sa.Column("created_by", UUIDString(), nullable=True),
    sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
    sa.Column("updated_by", UUIDString(), nullable=True),
...
parse_revisions = sa.Table(
    "parse_revisions",
    metadata,
    sa.Column("parse_revision_id", UUIDString(), primary_key=True),
    sa.Column("document_version_id", UUIDString(), nullable=False),
    ...
    sa.Column("parse_options", sa.JSON(), nullable=False, server_default="{}"),
    sa.Column("status", sa.String(length=16), nullable=False),
    sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
    sa.Column("created_by", UUIDString(), nullable=True),
    sa.Column("deleted_at", sa.DateTime(timezone=True), nullable=True),
...
chunk_revisions = sa.Table(
    "chunk_revisions",
    metadata,
    sa.Column("chunk_revision_id", UUIDString(), primary_key=True),
    sa.Column("binding_id", UUIDString(), nullable=False),
    sa.Column("knowledge_base_id", UUIDString(), nullable=False),
    sa.Column("document_id", UUIDString(), nullable=False),
    sa.Column("document_version_id", UUIDString(), nullable=False),
    sa.Column("parse_revision_id", UUIDString(), nullable=False),
    sa.Column("status", sa.String(length=16), nullable=False),
...
ingest_jobs = sa.Table(
    ...
    sa.Column("kb_id", UUIDString(), nullable=False),
    sa.Column("document_id", UUIDString(), nullable=True),
    sa.Column("version_id", UUIDString(), nullable=True),
    sa.Column("job_type", sa.String(length=32), nullable=False),
    sa.Column("status", sa.String(length=16), nullable=False),
    sa.Column("stage", sa.String(length=64), nullable=True),
    sa.Column("progress", sa.Integer(), nullable=False),
    sa.Column("retry_of_job_id", UUIDString(), nullable=True),
    sa.Column("error_code", sa.String(length=64), nullable=True),
    sa.Column("error_message", sa.Text(), nullable=True),
...
chunks = sa.Table(
    "chunks",
    metadata,
    sa.Column("chunk_id", UUIDString(), primary_key=True),
    sa.Column("version_id", UUIDString(), nullable=False),
    sa.Column("document_id", UUIDString(), nullable=False),
    sa.Column("kb_id", UUIDString(), nullable=False),
    ...
    sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
    # 新增字段
    sa.Column("chunk_revision_id", UUIDString(), nullable=True),
    sa.Column("parse_revision_id", UUIDString(), nullable=True),
    sa.Column("document_version_id", UUIDString(), nullable=True),
    ...
    sa.Column("retired_at", sa.DateTime(timezone=True), nullable=True),
    sa.Column("retired_by", UUIDString(), nullable=True),
    sa.Column("deleted_at", sa.DateTime(timezone=True), nullable=True),
    sa.Column("deleted_by", UUIDString(), nullable=True),
)
...
index_sync_jobs = sa.Table(
    "index_sync_jobs",
    metadata,
    sa.Column("sync_job_id", UUIDString(), primary_key=True),
    sa.Column("kb_id", UUIDString(), nullable=False),
...
index_sync_records = sa.Table(
    "index_sync_records",
    metadata,
    sa.Column("sync_record_id", UUIDString(), primary_key=True),
    sa.Column("sync_job_id", UUIDString(), nullable=False),
    sa.Column("target_store", sa.String(length=32), nullable=False),
    sa.Column("resource_type", sa.String(length=32), nullable=False),
    sa.Column("resource_id", UUIDString(), nullable=False),
...
config_templates = sa.Table(
    "config_templates",
    metadata,
    sa.Column("template_id", UUIDString(), primary_key=True),
    sa.Column("name", sa.String(length=128), nullable=False),
    sa.Column("description", sa.Text(), nullable=True),
...
config_revisions = sa.Table(
    "config_revisions",
    metadata,
    sa.Column("config_revision_id", UUIDString(), primary_key=True),
    sa.Column("kb_id", UUIDString(), nullable=False),
    sa.Column("revision_no", sa.Integer(), nullable=False),
    sa.Column("source_template_id", UUIDString(), nullable=True),
    sa.Column("status", sa.String(length=16), nullable=False),
    sa.Column("pipeline_definition", sa.JSON(), nullable=False),
    sa.Column("validation_snapshot", sa.JSON(), nullable=False),
    sa.Column("remark", sa.Text(), nullable=True),
    sa.Column("activated_at", sa.DateTime(timezone=True), nullable=True),
    sa.Column("activated_by", UUIDString(), nullable=True),
    sa.Column("deactivated_at", sa.DateTime(timezone=True), nullable=True),
    sa.Column("deactivated_by", UUIDString(), nullable=True),
    sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
    sa.Column("created_by", UUIDString(), nullable=True),
    sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
    sa.Column("updated_by", UUIDString(), nullable=True),
...
qa_runs = sa.Table(
    "qa_runs",
    metadata,
    sa.Column("run_id", UUIDString(), primary_key=True),
    sa.Column("kb_id", UUIDString(), nullable=False),
    sa.Column("config_revision_id", UUIDString(), nullable=False),
    sa.Column("source_run_id", UUIDString(), nullable=True),
    sa.Column("query", sa.Text(), nullable=False),
    sa.Column("rewritten_query", sa.Text(), nullable=True),
    sa.Column("status", sa.String(length=16), nullable=False),
    sa.Column("answer", sa.Text(), nullable=True),
    sa.Column("has_override", sa.Boolean(), nullable=False),
    sa.Column("override_snapshot", sa.JSON(), nullable=False),
    sa.Column("pipeline_snapshot", sa.JSON(), nullable=False),
    sa.Column("node_param_snapshot", sa.JSON(), nullable=False),
...
qa_run_trace_steps = sa.Table(
    "qa_run_trace_steps",
    metadata,
    sa.Column("trace_step_id", UUIDString(), primary_key=True),
...
qa_run_candidates = sa.Table(
    "qa_run_candidates",
    metadata,
    sa.Column("candidate_id", UUIDString(), primary_key=True),
    sa.Column("run_id", UUIDString(), nullable=False),
    sa.Column("chunk_id", UUIDString(), nullable=True),
    sa.Column("source_type", sa.String(length=32), nullable=False),
...
qa_run_evidence = sa.Table(
    "qa_run_evidence",
    metadata,
    sa.Column("evidence_id", UUIDString(), primary_key=True),
    sa.Column("run_id", UUIDString(), nullable=False),
    sa.Column("chunk_id", UUIDString(), nullable=False),
    sa.Column("candidate_id", UUIDString(), nullable=True),
...
qa_run_citations = sa.Table(
    "qa_run_citations",
    metadata,
    sa.Column("citation_id", UUIDString(), primary_key=True),
    sa.Column("run_id", UUIDString(), nullable=False),
    sa.Column("evidence_id", UUIDString(), nullable=False),
...
rag_apps = sa.Table(
    "rag_apps",
    metadata,
    sa.Column("app_id", UUIDString(), primary_key=True),
    sa.Column("kb_id", UUIDString(), nullable=False),
    sa.Column("default_config_revision_id", UUIDString(), nullable=True),
    sa.Column("name", sa.String(length=128), nullable=False),
    sa.Column("description", sa.Text(), nullable=True),
    sa.Column("status", sa.String(length=16), nullable=False),
...
rag_app_api_keys = sa.Table(
    "rag_app_api_keys",
    metadata,
    sa.Column("api_key_id", UUIDString(), primary_key=True),
    ...
    sa.Column("revoked_by", UUIDString(), nullable=True),
)

embedded_app_deployments = sa.Table(
    "embedded_app_deployments",
    metadata,
    sa.Column("deployment_id", UUIDString(), primary_key=True),
    sa.Column("app_id", UUIDString(), nullable=False),
    sa.Column("app_type", sa.String(length=32), nullable=False),
    sa.Column("api_key_id", UUIDString(), nullable=False),
...
app_conversations = sa.Table(
    "app_conversations",
    metadata,
    sa.Column("conversation_id", UUIDString(), primary_key=True),
    sa.Column("app_id", UUIDString(), nullable=False),
...
app_messages = sa.Table(
    ...
    sa.Column("conversation_id", UUIDString(), nullable=False),
    sa.Column("role", sa.String(length=16), nullable=False),
    sa.Column("content", sa.Text(), nullable=False),
    sa.Column("qa_run_id", UUIDString(), nullable=True),
    sa.Column("status", sa.String(length=16), nullable=False),
    sa.Column("metadata", sa.JSON(), nullable=False),
    sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
)
...
app_invocations = sa.Table(
    "app_invocations",
    metadata,
    sa.Column("invocation_id", UUIDString(), primary_key=True),
    sa.Column("app_id", UUIDString(), nullable=False),
    sa.Column("api_key_id", UUIDString(), nullable=True),
    sa.Column("conversation_id", UUIDString(), nullable=True),
    sa.Column("message_id", UUIDString(), nullable=True),
    sa.Column("qa_run_id", UUIDString(), nullable=True),
    sa.Column("status", sa.String(length=16), nullable=False),
    sa.Column("error_code", sa.String(length=64), nullable=True),
...
training_post_quizzes = sa.Table(
    ...
    metadata,
    sa.Column("quiz_id", UUIDString(), primary_key=True),
    sa.Column("app_id", UUIDString(), nullable=False),
    sa.Column("session_id", UUIDString(), nullable=False),
    sa.Column("end_user_id", sa.String(length=128), nullable=False),
...
training_question_appeals = sa.Table(
    ...
    metadata,
    sa.Column("appeal_id", UUIDString(), primary_key=True),
    sa.Column("app_id", UUIDString(), nullable=False),
    sa.Column("question_id", UUIDString(), nullable=False),
    sa.Column("end_user_id", sa.String(length=128), nullable=False),
...
evaluation_samples = sa.Table(
    "evaluation_samples",
    metadata,
    sa.Column("sample_id", UUIDString(), primary_key=True),
    sa.Column("kb_id", UUIDString(), nullable=False),
    sa.Column("source_run_id", UUIDString(), nullable=True),
    sa.Column("query", sa.Text(), nullable=False),
...
evaluation_runs = sa.Table(
    "evaluation_runs",
    metadata,
    sa.Column("evaluation_run_id", UUIDString(), primary_key=True),
    sa.Column("kb_id", UUIDString(), nullable=False),
    sa.Column("config_revision_id", UUIDString(), nullable=False),
    sa.Column("status", sa.String(length=16), nullable=False),
...
evaluation_results = sa.Table(
    "evaluation_results",
    metadata,
    sa.Column("evaluation_result_id", UUIDString(), primary_key=True),
    sa.Column("evaluation_run_id", UUIDString(), nullable=False),
    sa.Column("sample_id", UUIDString(), nullable=False),
    sa.Column("source_run_id", UUIDString(), nullable=True),
    sa.Column("actual_run_id", UUIDString(), nullable=True),
    sa.Column("status", sa.String(length=16), nullable=False),
    sa.Column("query", sa.Text(), nullable=False),
    sa.Column("expected_answer", sa.Text(), nullable=True),
...
graph_snapshots = sa.Table(
    "graph_snapshots",
    metadata,
    sa.Column("graph_snapshot_id", UUIDString(), primary_key=True),
    sa.Column("kb_id", UUIDString(), nullable=False),
...
graph_chunk_refs = sa.Table(
    "graph_chunk_refs",
    metadata,
    sa.Column("graph_chunk_ref_id", UUIDString(), primary_key=True),
    sa.Column("graph_snapshot_id", UUIDString(), nullable=False),
    sa.Column("chunk_id", UUIDString(), nullable=False),
