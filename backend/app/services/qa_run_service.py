    ...
    if chunk_ids:
        rows = session.execute(
            ...
            .where(
                ...
                sa.or_(
                    document_kb_bindings.c.active_chunk_revision_id.is_(None),
                    chunks.c.chunk_revision_id.is_(None),
                    chunks.c.chunk_revision_id == document_kb_bindings.c.active_chunk_revision_id,
                ),
            )
        ).mappings()
        ...
        authorized_candidate = ProviderCandidate(
            ...
            metadata={
                ...
                **chunk_metadata,
                ...
                "chunkRevisionId": str(chunk_row["chunk_revision_id"]) if chunk_row["chunk_revision_id"] else None,
        ...
        session.execute(
            insert(qa_run_citations).values(
                ...
                location_snapshot={
                    ...
                    "chunkRevisionId": candidate.metadata.get("chunkRevisionId"),
    ...
    def _to_authorized_evidence_dto(evidence_row: RowMapping) -> QARunEvidenceDTO:
        ...
        if evidence_row["source_status"] == "source_deleted":
            return QARunEvidenceDTO(
                ...
                chunkRevisionId=str(metadata.get("chunk_revision_id")) if metadata.get("chunk_revision_id") else None,
